...
HTH = zeros(size(G,1)*size(T_HbO_brain,2)+ size(G_scalp,1)*size(T_scalp,2)); % HTH = [240, 240]
HTY = zeros(size(G,1)*size(T_HbO_brain,2)+ size(G_scalp,1)*size(T_scalp,2), 1); % HTY = [240, 1]
j1 = 0;
